<?php
//git token: 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
...
//                'email' => $email,
    ...
    public function getSoapUser($id){
        ...
        $soapclient = new SoapClient(env('WSDL_URL')); //Live url
...
//                    "segm" => isset($result->Account->AccountSegment) ? $result->Account->AccountSegment : " ",
    ...
    public function getSoapUserTest($id){
        $soapclient = new SoapClient(env('WSDL_URL'));
        $params = array(
            "CustomerId" => $id
        );
        //22563316
